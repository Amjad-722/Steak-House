...
<main class="h-dvh pt-20 relative">
  ...
  <div class="relative grid grid-cols-1 md:grid-cols-2 gap-8 px-12 z-10 max-w-7xl mx-auto">
    {#each testimonials as testimonial}
      <div
        class="border-2 border-gray-300 hover:border-fontColor text-white transition hover:translate-x-3 duration-300 p-6 rounded-md shadow-md bg-bgColor bg-opacity-80  w-full"
      >
